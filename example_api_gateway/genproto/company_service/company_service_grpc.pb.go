...
type CompanyServiceClient interface {
	...
	Update(ctx context.Context, in *Company, opts ...grpc.CallOption) (*UpdateCompany, error)
	Delete(ctx context.Context, in *CompanyId, opts ...grpc.CallOption) (*UpdateCompany, error)
}
...
func (c *companyServiceClient) Update(ctx context.Context, in *Company, opts ...grpc.CallOption) (*UpdateCompany, error) {
	out := new(UpdateCompany)
...
func (c *companyServiceClient) Delete(ctx context.Context, in *CompanyId, opts ...grpc.CallOption) (*UpdateCompany, error) {
	out := new(UpdateCompany)
...
type CompanyServiceServer interface {
	...
	Update(context.Context, *Company) (*UpdateCompany, error)
	Delete(context.Context, *CompanyId) (*UpdateCompany, error)
...
func (UnimplementedCompanyServiceServer) Update(context.Context, *Company) (*UpdateCompany, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedCompanyServiceServer) Delete(context.Context, *CompanyId) (*UpdateCompany, error) {
